...
import ED from './production/ed.json';
import EDPrescriptionRenewal from './shared/ed-renewal.json';
import GAD7 from './production/gad-7.json';
import BMS from './shared/bipolar-and-mania-screener.json';
import PHQ9 from './production/phq-9.json';
import PHQ9checkin from './production/phq-9-checkin.json';
import PHQ9devfollowup from './production/phq-9-followup.json';
import HairLoss from './production/hair-loss.json';
import WeightLoss from './production/weight-loss.json';
import WeightLossV2 from './shared/weight-loss-4314.json';
import WeightLossPost from './shared/weight-loss-post.json';
import WeightLossPostV2 from './shared/weight-loss-post-v2.json';
import WeightLossEsp from './shared/weight-loss-esp.json';
...
import BirthControl from './production/birth-control.json';
...
import MentalHealthTreatment from './production/mental-health-treatment.json';
...
import MedicalHistory from './production/general-intake.json';
import BloodPressure from './production/blood-pressure.json';
import HeightWeight from './production/height-weight.json';
import BirthControlUpsell from './production/birth-control-upsell.json';
import DrugsAlcoholTobacco from './production/drugs-alcohol-tobacco.json';
...
import AsyncMedicalHistory from './production/async-medical-history.json';
...
import AntiAgingTreatment from './production/anti-aging-treatment.json';
import PsychiatryPostCheckoutIntro from './shared/psychiatry-postcheckout-intro.json';
import MelasmaTreatment from './production/melasma-treatment.json';
import RosaceaTreatment from './production/rosacea-treatment.json';
import SkincareIntro from './shared/skincare-intro.json';
import WeightLossRefill from './production/weight-loss-refill.json';
import WeightLossRefillAdditional from './shared/weight-loss-refill-additional.json';
import WeightLossBundleRefill from './production/weight-loss-bundle-refill.json';
...
import Nonglp1Meds from './production/non-glp1-meds.json';
import NonGLP1MedsRequest from './shared/non-glp1-meds-request.json';
import AsyncMentalHealthIntro from './shared/async-mental-health-intro.json';
...
import Enclomiphene from './production/enclomiphene.json';
...
import AcneIntro from '@/questionnaires/shared/acne-intro.json';
import RosaceaIntro from '@/questionnaires/shared/rosacea-intro.json';
import MelasmaIntro from '@/questionnaires/shared/melasma-intro.json';
import AntiAgingIntro from '@/questionnaires/shared/anti-aging-intro.json';
...
import EDHL from '@/questionnaires/shared/ed-hl.json';
...
export const prodMapping: { [key in QuestionnaireName]: Questionnaire | null } =
  {
    ed: ED as unknown as Questionnaire,
    ...
    'gad-7': GAD7 as unknown as Questionnaire,
    'bipolar-and-mania-screener': BMS as unknown as Questionnaire,
    'phq-9': PHQ9 as unknown as Questionnaire,
    'phq-9-checkin': PHQ9checkin as unknown as Questionnaire,
    'phq-9-followup': PHQ9devfollowup as unknown as Questionnaire,
    'hair-loss': HairLoss as unknown as Questionnaire,
    'weight-loss': WeightLoss as unknown as Questionnaire,
    'weight-loss-esp': WeightLossEsp as unknown as Questionnaire,
    'weight-loss-v2': WeightLossV2 as unknown as Questionnaire,
    ...
    'birth-control': BirthControl as unknown as Questionnaire,
    ...
    'mental-health-treatment':
      MentalHealthTreatment as unknown as Questionnaire,
    ...
    'general-intake': MedicalHistory as unknown as Questionnaire,
    'height-weight': HeightWeight as unknown as Questionnaire,
    'blood-pressure': BloodPressure as unknown as Questionnaire,
    'birth-control-upsell': BirthControlUpsell as unknown as Questionnaire,
    'drugs-alcohol-tobacco': DrugsAlcoholTobacco as unknown as Questionnaire,
    ...
    'async-mental-health-intro':
      AsyncMentalHealthIntro as unknown as Questionnaire,
