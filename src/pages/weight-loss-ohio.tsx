...
const WeightLossOhioHome = () => {
  ...
  return (
    <>
      <Head>
        <title>Treat Weight Loss with Zealthy in Ohio</title>
      </Head>
    </>
  );
};

WeightLossOhioHome.getLayout = (page: ReactElement) => {
  return <DefaultNavLayout>{page}</DefaultNavLayout>;
};

export default WeightLossOhioHome;
