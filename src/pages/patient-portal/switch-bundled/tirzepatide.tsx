...
const SwitchBundledTirzepatide = (props: Props) => {
  return (
    <Container maxWidth="xs">
      <Head>
        <title>Switch to Bundled Subscription | Zealthy</title>
      </Head>
      <SwitchWeightLossBundled medication="tirzepatide" {...props} />
      <Footer />
    </Container>
  );
};
...
SwitchBundledTirzepatide.getLayout = (page: ReactElement) => {
  return <PatientPortalNav>{page}</PatientPortalNav>;
};

export default SwitchBundledTirzepatide;
