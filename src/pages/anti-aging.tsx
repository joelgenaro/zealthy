...
const AntiAgingTreatmentHome = () => {
  ...
  useEffect(() => {
    ...
    if (specificCare === SpecificCareOption.ANTI_AGING) {
  ...
  return (
    <>
      <Head>
        <title>Anti Aging Treatment | Zealthy</title>
      </Head>
    </>
  );
};

AntiAgingTreatmentHome.getLayout = (page: ReactElement) => {
  return <DefaultNavLayout>{page}</DefaultNavLayout>;
};

export default AntiAgingTreatmentHome;
