...
import { sexHairPaymentEvent } from '@/utils/freshpaint/events';
...
export const handleFirstPaidInvoiceForSexHair = async (invoice: Invoice) => {
  if (invoice.care?.toLowerCase().includes('sex + hair')) {
