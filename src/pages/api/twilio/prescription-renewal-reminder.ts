...
import { prescriptionRenewalReminder } from './call_scripts/prescription-renewal-reminder';
...
export default async function handler(
  ...
  try {
    if (phoneNumber) {
      await client.calls
        .create({
          twiml: prescriptionRenewalReminder,
          to: phoneNumber,
          ...
          asyncAmdStatusCallback:
            ...
            '/api/twilio/prescription-renewal-reminder-vm',
        })
        .then((call: any) => {
