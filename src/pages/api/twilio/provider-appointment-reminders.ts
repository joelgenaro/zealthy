...
import {
  providerAppointmentReminderOne,
  providerAppointmentReminderTwo,
  providerAppointmentReminderFour,
  providerAppointmentReminderThree,
} from './call_scripts';
      ...
      await client.calls
        .create({
          ...
          asyncAmdStatusCallback:
            ...
            '/api/twilio/provider-appointment-reminders-vm/' +
            messageNum,
        })
        .then((call: any) => {
