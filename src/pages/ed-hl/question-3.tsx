...
const question: QuestionWithName = {
  name: 'EDHL_PRESIGNUP_Q3',
  header: 'How often do your symptoms disrupt your sex life?',
  type: 'choice',
  questionnaire: 'ed-hl-presignup',
  answerOptions: [
    {
      text: 'Pretty often',
      code: 'EDHL_PRESIGNUP_Q3_A1',
    },
    {
      text: 'Occasionally',
      code: 'EDHL_PRESIGNUP_Q3_A2',
    },
    {
      text: 'Rarely',
      code: 'EDHL_PRESIGNUP_Q3_A3',
    },
  ],
};

const SexPlusHairQuestion3 = () => {
  ...
  const handleContinue = () => {
    ...
    Router.push(Pathnames.EDHL_PRESIGNUP_QUESTION_4);
  };
...
SexPlusHairQuestion3.getLayout = (page: ReactElement) => {
  return <NavBarLayout>{page}</NavBarLayout>;
};

export default SexPlusHairQuestion3;
