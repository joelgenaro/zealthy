...
const question: QuestionWithName = {
  name: 'EDHL_PRESIGNUP_Q5',
  header: 'How would you like to approach treatment options?',
  type: 'choice',
  questionnaire: 'ed-hl-presignup',
  answerOptions: [
    {
      text: 'I have a specific treatment in mind',
      code: 'EDHL_PRESIGNUP_Q5_A1',
    },
    {
      text: `I'd like a recommendation`,
      code: 'EDHL_PRESIGNUP_Q5_A2',
    },
  ],
};

const SexPlusHairQuestion5 = () => {
  ...
  const handleContinue = () => {
    ...
    Router.push(Pathnames.EDHL_PRESIGNUP_INFO_3);
  };
...
SexPlusHairQuestion5.getLayout = (page: ReactElement) => {
  return <NavBarLayout>{page}</NavBarLayout>;
};

export default SexPlusHairQuestion5;
