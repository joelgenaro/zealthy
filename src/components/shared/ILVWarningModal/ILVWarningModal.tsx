...
import { StandardModal } from '../modals/Modal';

interface ILVWarningModalProps {
  open: boolean;
  setOpen: (b: boolean) => void;
  onConfirm: () => Promise<void>;
}

const ILVWarningModal = ({
  open,
  setOpen,
  onConfirm,
}: ILVWarningModalProps) => {
    ...
    <StandardModal setModalOpen={setOpen} modalOpen={open}>
      <Stack gap="16px" alignItems="center">
        ...
        <Typography textAlign="center">
          If you leave the waiting room, then you’ll lose your spot in line.
        </Typography>
...
export default ILVWarningModal;
