...
const NoProvidersModal = ({ open, setOpen }: NoProvidersModal) => {
  ...
  return (
    <StandardModal setModalOpen={setOpen} modalOpen={open}>
      <Stack gap="16px" alignItems="center">
        ...
        <Button color="grey" onClick={scheduleInstead} fullWidth>
          Schedule a visit instead
        </Button>
        <Button variant="text" onClick={cancelAndClose} fullWidth>
...
export default NoProvidersModal;
