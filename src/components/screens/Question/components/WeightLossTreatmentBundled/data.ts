...
export const compoundDetails: {
  ...
  Semaglutide: {
    ...
    name: 'Semaglutide',
    body1:
      'In order to receive a 3 month supply of your medication, you will need to pay for your next 2 months of doctor + medication upfront.',
  },
  Tirzepatide: {
    saving: 180,
    price: 449,
