...
interface WeightLossOptions8116Props {
  checked: string;
...
const WeightLossOptions8116 = ({
  checked,
  compoundDetails,
  handleChange,
  handleConfirmQuantity,
}: WeightLossOptions8116Props) => {
    ...
    <>
      {medicationSelected && !review && quantity && (
        <Box>
          ...
          {/** ************************************************************************************ */}
          {/** 6 Month Option */}
          {seeMore && compoundDetails?.[medicationSelected].medSixMonthData && (
            <Box
              sx={{
                padding: '1.5rem',
                borderRadius: '1rem',
...
export default WeightLossOptions8116;
