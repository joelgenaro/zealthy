...
const WeightLossOptions = ({
  ...
  let threeMonthAverageWeightLossText = medicationSelected
    ?.toLowerCase()
    ?.includes('semaglutide')
    ? `On average, people lose 5% of their body weight in their first 3 months with semaglutide**`
    : `On average, people lose 7% of their body weight in their first 3 months with tirzepatide**`;
