...
const WeightLossOptions7746 = ({
  ...
  let threeMonthAverageWeightLossText = medicationSelected
    ?.toLowerCase()
    ?.includes('semaglutide')
    ? `On average, people lose 6.9% of their weight in their first 3 months of Semaglutide**`
  ...
  if (isUpdose) {
    averageWeightLossText = medicationSelected
      ...
      ?.includes('semaglutide')
      ? `On average, people lose 2.3% of their weight after 1 month on Semaglutide**`
      : `On average, people lose 5% of their weight after 1 month on Tirzepatide**`;

    threeMonthAverageWeightLossText = medicationSelected
      ?.toLowerCase()
      ?.includes('semaglutide')
      ? `On average, people lose 2.7% of their weight in their first 3 months of Semaglutide**`
      : `On average, people lose 7% of their weight in their first 3 months of Tirzepatide**`;
  }
                  ...
                  >
                    <Box>
                      <Typography variant="h3" fontWeight="600" mb="0.3rem">
                        {`${Math.round(
                          (1 -
                            compoundDetails?.[medicationSelected]
                              ?.medSixMonthData?.discounted_price! /
                              compoundDetails?.[medicationSelected]?.medData
                                .price!) *
                            100
                    ...
                    >
                      ...
                      {language === 'esp'
                        ? `$${Math.floor(
                            compoundDetails?.[medicationSelected]
                              ?.medSixMonthData?.discounted_price || 0
                          )}/mes para ${
                            compoundDetails?.[medicationSelected]?.name
...
export default WeightLossOptions7746;
