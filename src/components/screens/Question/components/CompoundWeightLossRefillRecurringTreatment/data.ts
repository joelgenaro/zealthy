...
export const medicationsSpanish = [
  ...
  },
  {
    ...
    body2:
      'Podrá intentar otros medicamentos si su seguro niega la cobertura, y también se le dará la opción de pagar de su bolsillo. La mayoría de los pacientes que usan Rybelsus perderán del 5 al 10% de su peso corporal en un año.',
  },
  {
    brand: 'Victoza',
    drug: 'Liraglutida',
...
export const compoundMedicationsSpanish = [
  {
    ...
    body2:
      'Como miembro del programa de pérdida de peso de Zealthy, ofrecemos acceso a una forma compuesta de Semaglutida si se prescribe**.',
    body3:
  ...
  },
  {
    ...
    body2:
      'Como miembro del programa de pérdida de peso de Zealthy, tiene acceso a una forma compuesta de Tirzepatida si se prescribe**.',
    body3:
